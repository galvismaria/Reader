...
class Lista{
    ...
    public:
        ...
        Lista();								// Constructor sin parÃ¡metros -> Crea una lista vacÃ­a
        ...
        void imprimirPaginas();					// Imprime las palabras que se encuentran en la lista y muestra en qué páginas aparecen
        
		void imprimirLineas();					// Imprime las palabras que se encuentran en la lista y muestra en qué líneas aparecen
